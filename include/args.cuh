...
namespace Config
{
    ...
    inline void set_device(int device_id, Params &p)
    {
    ...
    {
        std::cout << "Arguments:\n";
        std::cout << "\tInput File: " << p.input_file << "\n"
                  << "\tOutput File: " << p.output_file << "\n"
                  << "\tSeparator: " << p.separator << "\t(" << p.separator_char << ")\n"
                  ...
                  << (p.GPU_memory_allocation == gpu_memory_allocation::Device
                          ? "Device"
                      : p.GPU_memory_allocation == gpu_memory_allocation::Unified ? "Unified"
                                                                                  : "Pinned")
                  << "\n"
                  << "\tMining Method: "
                  << (p.method == mine_method::no_hash_table
